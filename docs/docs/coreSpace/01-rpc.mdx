...
1. **InvalidEpochType**
2. **SpecifiedEpochNotExecuted**
3. **EmptyEpochString**
4. **InvalidDigitEpoch**
5. **MissingHexPrefix**
6. **UnexpectedRpcAddressNetwork**
...
1. **InvalidEpochType**
2. **EpochNumberTooLarge**
3. **EmptyEpochString**
4. **InvalidDigitEpoch**
5. **MissingHexPrefix**
6. **BlockHashesLimitExceededError**
7. **ExceededTopicsLimitError**
8. **MissingFilterParametersError**
